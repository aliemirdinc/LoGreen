...
const CSS_IDENT_SAFE = /[^a-zA-Z0-9_-]/g
const CSS_VALUE_FORBIDDEN = /[;{}<>`\\]|\/\*/g

function sanitizeCssIdent(value: string) {
  return value.replace(CSS_IDENT_SAFE, '')
}

function sanitizeCssValue(value: string) {
  return value.replace(CSS_VALUE_FORBIDDEN, '').trim()
}
